import { version, unref, inject, defineComponent, h, getCurrentInstance, onUnmounted, useSSRContext, hasInjectionContext, computed, watch, Fragment, ref, withCtx, isRef, createVNode, createTextVNode, toDisplayString as toDisplayString$1, openBlock, createBlock, renderList, createApp, effectScope, reactive, shallowRef, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, isReadonly, Text, mergeProps, isShallow, isReactive, toRaw } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as sanitizeStatusCode, m as createHooks, p as parse$1, n as getRequestHeader, o as destr, q as isEqual$1, r as setCookie, t as getCookie, v as deleteCookie, w as getRequestHeaders } from '../nitro/node-server.mjs';
import { getActiveHead } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { useRouter as useRouter$1, useRoute as useRoute$1 } from 'vue-router';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode, ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
import { Icon } from '@iconify/vue';
import { SelectRoot, SelectTrigger, SelectValue, SelectPortal, SelectContent, SelectScrollUpButton, SelectViewport, SelectGroup, SelectItem, SelectItemIndicator, SelectItemText, SelectScrollDownButton } from 'radix-vue';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const vueI18nConfigs = [
  () => import(
    './_nuxt/i18n.config-Ti8DcgA0.mjs'
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-[1090px] mx-auto w-full" }, _attrs))}>`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Layout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(SelectRoot), {
              "onUpdate:modelValue": [handleChange, ($event) => isRef(lang) ? lang.value = $event : null],
              modelValue: unref(lang)
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(SelectTrigger), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(SelectValue), { placeholder: unref(lang) }, null, _parent4, _scopeId3));
                        ...
                        return [
                          createVNode(unref(SelectValue), { placeholder: unref(lang) }, null, 8, ["placeholder"]),
                  ...
                  _push3(ssrRenderComponent(unref(SelectPortal), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(SelectContent), {
                          class: "min-w-[160px] bg-white rounded shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade z-[100]",
                          "side-offset": 5
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(SelectScrollUpButton), { class: "flex items-center justify-center h-[25px] bg-white text-violet11 cursor-default" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(Icon), { icon: "radix-icons:chevron-up" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                              ...
                              _push5(ssrRenderComponent(unref(SelectViewport), { class: "p-[5px]" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(SelectGroup), null, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<!--[-->`);
                                          ssrRenderList(unref(availableLocales), (option, index) => {
                                            _push7(ssrRenderComponent(unref(SelectItem), {
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(unref(SelectItemIndicator), { class: "absolute left-0 w-[25px] inline-flex items-center justify-center" }, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(ssrRenderComponent(unref(Icon), { icon: "radix-icons:check" }, null, _parent9, _scopeId8));
                                                      } else {
                                                        return [
                                                  ...
                                                  _push8(ssrRenderComponent(unref(SelectItemText), null, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(`${ssrInterpolate(option)}`);
                                                      } else {
                                                        return [
                                                          createTextVNode(toDisplayString$1(option), 1)
                                                        ];
                                                      }
                                                    }),
                                                    _: 2
                                                  ...
                                                  return [
                                                    createVNode(unref(SelectItemIndicator), { class: "absolute left-0 w-[25px] inline-flex items-center justify-center" }, {
                                                      default: withCtx(() => [
                                                        createVNode(unref(Icon), { icon: "radix-icons:check" })
                                                      ]),
                                                      _: 1
                                          ...
                                          return [
                                            (openBlock(true), createBlock(Fragment, null, renderList(unref(availableLocales), (option, index) => {
                              ...
                              _push5(ssrRenderComponent(unref(SelectScrollDownButton), { class: "flex items-center justify-center h-[25px] bg-white text-violet11 cursor-default" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(Icon), { icon: "radix-icons:chevron-down" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                              ...
                              return [
                                createVNode(unref(SelectScrollUpButton), { class: "flex items-center justify-center h-[25px] bg-white text-violet11 cursor-default" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(Icon), { icon: "radix-icons:chevron-up" })
                                  ]),
                                  _: 1
                                }),
                                createVNode(unref(SelectViewport), { class: "p-[5px]" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(SelectGroup), null, {
                                      default: withCtx(() => [
                                        (openBlock(true), createBlock(Fragment, null, renderList(unref(availableLocales), (option, index) => {
                                ...
                                createVNode(unref(SelectScrollDownButton), { class: "flex items-center justify-center h-[25px] bg-white text-violet11 cursor-default" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(Icon), { icon: "radix-icons:chevron-down" })
                                  ]),
                                  _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Header/LanguageSwitch.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Layout = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex flex-col"><div class="jb-w--10">`);
      _push(ssrRenderComponent(_sfc_main$3, null, null, _parent));
      _push(`</div>`);
      _push(ssrRenderComponent(_component_Layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>${ssrInterpolate(_ctx.$t("hello"))}</p>`);
          } else {
            return [
              createVNode("p", null, toDisplayString$1(_ctx.$t("hello")), 1)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-8eLAtXg6.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-6ZTsBrMz.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-0sX92dKV.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, parseQuery$1 as a, useRuntimeConfig as b, createError as c, withoutTrailingSlash$1 as d, entry$1 as default, hasProtocol as h, injectHead as i, joinURL as j, navigateTo as n, parseURL as p, resolveUnrefHeadInput as r, useRouter as u, withTrailingSlash$1 as w };
